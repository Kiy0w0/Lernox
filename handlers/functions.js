  ...
  console.log(db)
    ...
    function reset(track_info_msg, queue_info_msg) {
      let embed2 = new MessageEmbed()
        ...
        .setTitle("Lernox Music | Music Queue")
        .setImage("https://i.pinimg.com/originals/22/2f/8c/222f8cfa9ba7e61269acb1b7a0155674.gif")
        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
      let embed3 = new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle("Lernox Music | Currently no song is playing!")
        .setDescription(`> Join a voice channel and enter a song name or url to play.\n\n[Invite Lernoxbot](https://morent1337.net) • [Support Server](https://discord.gg/fqjdsyEq24) • [Website](https://yurigane.carameloszy.repl.co)`)
        .setImage("https://c.tenor.com/vEtJhksxagsAAAAC/loona-loona-hi-high.gif")
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`Lernox Music | Music Queue`);
      const multiple = 15;
      const page = 1;
   ...
   embed.setColor(ee.color);
      embed.setImage("https://i.pinimg.com/originals/22/2f/8c/222f8cfa9ba7e61269acb1b7a0155674.gif");
      embed.setFooter(ee.footertext, ee.footericon);
      return embed;
    }
    function format(millis) {
