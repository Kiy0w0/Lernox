                  ...
                  message.guild.channels
                    ...
                    .then(async (channel3) => {
                      ...
                      let embed2 = new MessageEmbed()
                        ...
                        .setImage("https://thumbs.gfycat.com/HorribleSeveralCaimanlizard-max-1mb.gif")
                      let embed3 = new MessageEmbed()
                        ...
                        .setDescription(
                          `Join a voice channel and enter a song name or url to play.\n**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://discord.gg/fqjdsyEq24)\`|\`[Youtube](https://www.youtube.com/MorenT/)\`**`
                        )
